<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="RegisterEx.aspx.cs" Inherits="PCIWebFinAid.RegisterEx" ValidateRequest="false" %>
...
//	base: "border: solid 2px #656565;transition: border 0.3s;box-shadow: inset 0 0 0 1px #454545;transition: box-shadow 0.3s, border 0.3s;background: -webkit-linear-gradient(#FAFAFA, #F4F4F4 40%, #E5E5E5);width: 100%;padding: 12px;color: #4c4c4c;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;outline-width: 0;margin: 5px 0;font-size: 16px;",
