...
<form id="frmHome" runat="server">
	...
	<div style="margin:0 auto;width:100%;display:inline-block">
		<asp:Image runat="server" ID="P12003" style="width:25%;display:inline-block;padding:10px;float:left;min-width:20% !important;margin:2px;" />
		<asp:Image runat="server" ID="P12004" style="width:25%;display:inline-block;padding:10px;float:left;min-width:20% !important;margin:2px;" />
		<asp:Image runat="server" ID="P12005" style="width:25%;display:inline-block;padding:10px;float:left;min-width:20% !important;margin:2px;" />
	</div> 
