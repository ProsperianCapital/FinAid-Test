...
<tr>
	...
	<td><asp:TextBox runat="server" ID="txtAmount" style="width:160px" onChange="JavaScript:Validate(1)"></asp:TextBox>&nbsp;
		<img id="imgY1" src="<%=PCIBusiness.Tools.ImageFolder() %>Tick.png"  style="visibility:hidden;display:none" />
		<img id="imgN1" src="<%=PCIBusiness.Tools.ImageFolder() %>Cross.png" style="visibility:hidden;display:none" /></td></tr>
<tr>
...
<tr>
	...
	<td><asp:TextBox runat="server" ID="txtBank" style="width:360px" onChange="JavaScript:Validate(2)"></asp:TextBox>&nbsp;
		<img id="imgY2" src="<%=PCIBusiness.Tools.ImageFolder() %>Tick.png"  style="visibility:hidden;display:none" />
		<img id="imgN2" src="<%=PCIBusiness.Tools.ImageFolder() %>Cross.png" style="visibility:hidden;display:none" /></td></tr>
<tr>
	<td><asp:Literal runat="server" ID="X104063">104063</asp:Literal></td>
	<td><asp:TextBox runat="server" ID="txtAccName" style="width:360px" onChange="JavaScript:Validate(3)"></asp:TextBox>&nbsp;
		<img id="imgY3" src="<%=PCIBusiness.Tools.ImageFolder() %>Tick.png"  style="visibility:hidden;display:none" />
		<img id="imgN3" src="<%=PCIBusiness.Tools.ImageFolder() %>Cross.png" style="visibility:hidden;display:none" /></td></tr>
<tr>
	<td><asp:Literal runat="server" ID="X104067">104067</asp:Literal></td>
	<td><asp:TextBox runat="server" ID="txtAccNumber" style="width:360px" onChange="JavaScript:Validate(4)"></asp:TextBox>&nbsp;
		<img id="imgY4" src="<%=PCIBusiness.Tools.ImageFolder() %>Tick.png"  style="visibility:hidden;display:none" />
		<img id="imgN4" src="<%=PCIBusiness.Tools.ImageFolder() %>Cross.png" style="visibility:hidden;display:none" /></td></tr>
<tr>
	<td><asp:Literal runat="server" ID="X104069">104069</asp:Literal></td>
	<td><asp:TextBox runat="server" ID="txtBranchName" style="width:360px" onChange="JavaScript:Validate(5)"></asp:TextBox>&nbsp;
		<img id="imgY5" src="<%=PCIBusiness.Tools.ImageFolder() %>Tick.png"  style="visibility:hidden;display:none" />
		<img id="imgN5" src="<%=PCIBusiness.Tools.ImageFolder() %>Cross.png" style="visibility:hidden;display:none" /></td></tr>
<tr>
	<td><asp:Literal runat="server" ID="X104377">104377</asp:Literal></td>
	<td><asp:TextBox runat="server" ID="txtBranchCode" style="width:360px" onChange="JavaScript:Validate(6)"></asp:TextBox>&nbsp;
		<img id="imgY6" src="<%=PCIBusiness.Tools.ImageFolder() %>Tick.png"  style="visibility:hidden;display:none" />
		<img id="imgN6" src="<%=PCIBusiness.Tools.ImageFolder() %>Cross.png" style="visibility:hidden;display:none" /></td></tr>
<tr>
